...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        # q: [num_batched_tokens, num_attention_heads, head_dim]
        #kv: [num_batched_tokens, num_key_value_heads, head_dim]
        # o: [num_batched_tokens, num_attention_heads, head_dim]
...
class Qwen3DecoderLayer(nn.Module):
    ...
    def forward(
        ...
        hidden_states = hidden_states + residual
        hidden_states, residual = self.post_attention_layernorm(hidden_states), hidden_states
